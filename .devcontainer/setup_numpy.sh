...
docker cp /workspaces/BugGPT/.devcontainer/setup_numpy_to_run_in_container.sh numpy-dev2:/root/setup.sh
...
docker cp /workspaces/BugGPT/.devcontainer/setup_numpy_to_run_in_container.sh numpy-dev3:/root/setup.sh
