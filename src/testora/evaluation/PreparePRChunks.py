...
if __name__ == "__main__":
    ...
    # scipy PRs that had "no tests were generated" issue:
    write_specific_PR_tasks_into_database("scipy", "scipy/scipy",
                                          [22273, 23498, 22481, 23454, 23121, 22284, 22869, 22215, 22689, 23415, 23138, 22982, 22494, 22242, 22220, 23071, 22221, 22313,
                                              22971, 22651, 22226, 22251, 22610, 22611, 22600, 22763, 23294, 23483, 22718, 23276, 22219, 22772, 23311, 23235, 22433]
                                          )
    ...
    # pandas PRs that had "no tests were generated" issue:
    write_specific_PR_tasks_into_database("pandas", "pandas-dev/pandas",
                                          [60916, 61597, 61207, 61008, 62073, 61517, 62076, 60867, 60828, 61773, 61990, 61874, 60975, 60949,
                                              61332, 62038, 61786, 61225, 61017, 60795, 61894, 61340, 61183, 62085, 61105, 61320, 60924, 61946]
                                          )
    ...
    # keras PRs that had "no tests were generated" issue:
    write_specific_PR_tasks_into_database("keras", "keras-team/keras",
                                          [21373, 20854, 20643, 21184, 21336, 21512, 21496, 20630, 21302, 20824, 20913, 21412, 20853, 21569, 20815, 20905, 21495, 21291, 21682,
                                              21170, 21331, 21349, 21414, 21290, 21066, 21480, 21192, 20989, 20755, 21432, 21014, 21361, 20829, 21532, 21588, 21010, 21449, 21392]
                                          )
    ...
    # marshmallow PRs that had "no tests were generated" issue:
    # write_specific_PR_tasks_into_database("marshmallow", "marshmallow-code/marshmallow",
    #                                       [1399, 903, 2699, 2762, 2706, 2755, 1501, 1246, 1136, 707, 1392, 769, 2754,
    #                                           2164, 1010, 1063, 1209, 822, 1785, 2798, 1354, 1551, 2764, 1574, 1682, 1276]
    #                                       )
