...
1) Is the different output a noteworthy change in behavior, as opposed to, e.g., changing only a line number in a stack trace or a minor change in formatting? Answer either "minor" or "noteworthy".
